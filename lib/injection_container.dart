...
import 'package:firebase_chat/domain/use_cases/create_group_usecase.dart';
import 'package:firebase_chat/domain/use_cases/get_all_group_usecase.dart';
import 'package:firebase_chat/domain/use_cases/get_all_users_usecase.dart';
import 'package:firebase_chat/domain/use_cases/get_create_current_user_usecase.dart';
import 'package:firebase_chat/domain/use_cases/get_current_uid_usecase.dart';
import 'package:firebase_chat/domain/use_cases/get_messages_usecase.dart';
import 'package:firebase_chat/domain/use_cases/get_update_user_usecase.dart';
import 'package:firebase_chat/domain/use_cases/join_group_usecase.dart';
import 'package:firebase_chat/domain/use_cases/send_text_message_usecase.dart';
import 'package:firebase_chat/domain/use_cases/update_group_usecase.dart';
import 'package:firebase_chat/presentation/cubit/group/group_cubit.dart';
...
import 'data/remote/data_sources/firebase_remote_data_source_impl.dart';
import 'data/repositories/firebase_repository_impl.dart';
import 'domain/repositories/firebase_repository.dart';
import 'domain/use_cases/forgot_password_usecase.dart';
import 'domain/use_cases/google_sign_in_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<GetCreateGroupUseCase>(() => GetCreateGroupUseCase(repository: sl.call()));
  ...
  sl.registerLazySingleton<SendTextMessageUseCase>(() => SendTextMessageUseCase(repository: sl.call()));
