...
import 'package:firebase_chat/domain/entities/single_chat_entity.dart';
import 'package:firebase_chat/page_const.dart';
...
import 'package:firebase_chat/presentation/widgets/single_item_group_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pushNamed(context, PageConst.createGroupPage, arguments: uid);
        },
              ...
              builder: (context, groupState) {
                if (groupState is GroupLoaded) {
                  final filteredGroups = groupState.groups
                      .where((group) =>
                          group.groupName.startsWith(query!) || group.groupName.startsWith(query!.toLowerCase()))
                      .toList();
                                    ...
                                    return SingleItemGroupWidget(
                                      ...
                                      onTap: () {
                                        BlocProvider.of<GroupCubit>(context)
                                            .joinGroup(groupEntity: GroupEntity(groupId: filteredGroups[index].groupId))
                                            .then((value) {
