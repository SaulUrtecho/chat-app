...
class SingleChatPage extends StatefulWidget {
  ...
  const SingleChatPage({Key? key, required this.singleChatEntity}) : super(key: key);
      ...
      child: Row(
        children: [
          Expanded(
            child: Container(
              decoration:
                  BoxDecoration(color: Colors.white, borderRadius: BorderRadius.all(Radius.circular(80)), boxShadow: [
                BoxShadow(
