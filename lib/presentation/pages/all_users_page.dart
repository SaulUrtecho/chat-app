...
import 'package:firebase_chat/presentation/widgets/single_item_user_widget.dart';
        ...
        builder: (context, userState) {
          if (userState is UserLoaded) {
            ...
            final filteredUsers = users
                .where(
                    (user) => user.name.startsWith(widget.query!) || user.name.startsWith(widget.query!.toLowerCase()))
                .toList();
            return Column(
              children: [
                Expanded(
